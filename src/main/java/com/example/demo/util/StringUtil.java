...
public class StringUtil {
	...
	public static Long toLong(Object obj) {
		return isNotNull(obj) ? Long.valueOf(StringUtil.toString(obj)) : null;
	}

	public static Double toDouble(Object obj, Double defaultVlue) {
		return isNotNull(obj) ? Double.valueOf(StringUtil.toString(obj)) : defaultVlue;
	}
	...
	public static Long getNowTime(String style) {
		return Long.valueOf(getStrNowTime(style));
	}

	public static String getStrNowTime(String style) {
